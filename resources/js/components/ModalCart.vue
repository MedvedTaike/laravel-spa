          ...
          <div class="d-flex justify-space-between">
              <div>
                ...
                <v-card-text>
                  ...
                  <p v-if="(getProduct.convert_price > 1)">Цена за <strong>{{getProduct.convert_price}}</strong> (<strong class="red--text">{{ getProduct.convert_price * getProduct.price | price}} </strong> ) сом.</p>
